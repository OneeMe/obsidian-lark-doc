...
Lark Wiki 是一个 Obsidian 桌面端插件，用于把本地 vault 中的 `.lark.md` 影子文件与 Lark / 飞书云文档关联起来。插件的目标是让用户在 Obsidian 中像打开普通 Markdown 一样打开远端文档，同时保留本地索引、标题同步和 Obsidian Bases 汇总能力。
...
- Lark 与飞书在产品和域名上并存，插件品牌使用 Lark Wiki，但仍支持 `feishu.cn` 和 `larksuite.com` 链接。
