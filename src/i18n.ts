...
const EN_TRANSLATIONS = {
	...
	"notice.baseCreateFailed": "Obsidian Lark loaded, but failed to create the Lark documents base: {{message}}",
...
const ZH_CN_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
	...
	"notice.baseCreateFailed": "Obsidian Lark 已加载，但创建 Lark 文档 Base 失败：{{message}}",
