...
const EN_TRANSLATIONS = {
	...
	"settings.shortcutForwarding": "Shortcut forwarding",
	"settings.shortcutAllowlist.name": "Forwarded shortcuts",
	"settings.shortcutAllowlist.desc": "Record shortcuts that should leave the Lark WebView and run in Obsidian. Empty list keeps every shortcut in the WebView.",
	"settings.shortcutAllowlist.record": "Record shortcut",
	"settings.shortcutAllowlist.recording": "Press shortcut",
	"settings.shortcutAllowlist.invalid": "Shortcut not saved. Use Mod, Ctrl, Alt, or F1-F24.",
	"settings.shortcutAllowlist.empty": "No forwarded shortcuts",
	"settings.shortcutAllowlist.emptyDesc": "All keyboard input stays in the Lark WebView.",
	"settings.shortcutAllowlist.delete": "Delete",
	"settings.shortcutAllowlist.deleteShortcut": "Delete {{shortcut}}",
	"settings.shortcutAllowlist.manage": "Manage forwarded shortcuts",
	"settings.shortcutAllowlist.manageDesc": "Clear every forwarded shortcut or restore the default Mod+W shortcut.",
	"settings.shortcutAllowlist.clear": "Clear",
	"settings.shortcutAllowlist.restoreDefaults": "Restore defaults",
	...
	"notice.baseCreateFailed": "Lark Wiki loaded, but failed to create the Lark documents base: {{message}}",
...
const ZH_CN_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
	...
	"settings.customCss.placeholder": ".header { display: none !important; }",
	"settings.shortcutForwarding": "快捷键转交",
	"settings.shortcutAllowlist.name": "转交的快捷键",
	"settings.shortcutAllowlist.desc": "录制需要离开 Lark WebView 并交给 Obsidian 响应的快捷键。列表为空时，所有快捷键都留在 WebView。",
	"settings.shortcutAllowlist.record": "录制快捷键",
	"settings.shortcutAllowlist.recording": "按下快捷键",
	"settings.shortcutAllowlist.invalid": "未保存快捷键。请使用 Mod、Ctrl、Alt 或 F1-F24。",
	"settings.shortcutAllowlist.empty": "没有转交的快捷键",
	"settings.shortcutAllowlist.emptyDesc": "所有键盘输入都会留在 Lark WebView。",
	"settings.shortcutAllowlist.delete": "删除",
	"settings.shortcutAllowlist.deleteShortcut": "删除 {{shortcut}}",
	"settings.shortcutAllowlist.manage": "管理转交快捷键",
	"settings.shortcutAllowlist.manageDesc": "清空所有转交快捷键，或恢复默认的 Mod+W 快捷键。",
	"settings.shortcutAllowlist.clear": "清空",
	"settings.shortcutAllowlist.restoreDefaults": "恢复默认值",
	...
	"notice.baseCreateFailed": "Lark Wiki 已加载，但创建 Lark 文档 Base 失败：{{message}}",
