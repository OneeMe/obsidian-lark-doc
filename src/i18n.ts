...
const EN_TRANSLATIONS = {
	...
	"modal.feishuUrl.label": "Lark or Feishu document URL",
	...
	"notice.fetchTitleFailed": "Could not fetch Lark document title.",
	"notice.templateNotFound": "Template not found: {{path}}",
	"notice.addedLinkedDocument": "Added linked Lark document: {{title}}",
	"notice.addLinkedDocumentFailed": "Failed to add linked Lark document: {{message}}",
	...
	"view.copyLinkAction": "Copy Lark document link",
	"view.noLinkedFile": "No linked Obsidian file to sync.",
	"view.syncUnavailable": "Sync is not available for this view.",
	"view.copyLinkUnavailable": "No Lark document link to copy.",
	"view.copyLinkFailed": "Failed to copy Lark document link: {{message}}",
	...
	"shadow.description": "This note is a local proxy for a Lark or Feishu wiki document.",
	"shadow.wikiUrl": "Wiki URL",
	"shadow.nodeInfo": "Node info (via lark-cli)",
	"shadow.footer": "This file contains only front matter metadata. The full content resides in Lark and can be viewed at the wiki URL above.",
...
const ZH_CN_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
	...
	"modal.feishuUrl.label": "Lark/飞书文档 URL",
	...
	"notice.fetchTitleFailed": "无法获取 Lark 文档标题。",
	"notice.templateNotFound": "未找到模板：{{path}}",
	"notice.addedLinkedDocument": "已添加关联 Lark 文档：{{title}}",
	"notice.addLinkedDocumentFailed": "添加关联 Lark 文档失败：{{message}}",
	...
	"view.copyLinkAction": "复制 Lark 文档链接",
	"view.noLinkedFile": "没有可同步的关联 Obsidian 文件。",
	"view.syncUnavailable": "当前视图不可同步。",
	"view.copyLinkUnavailable": "没有可复制的 Lark 文档链接。",
	"view.copyLinkFailed": "复制 Lark 文档链接失败：{{message}}",
	...
	"shadow.title": "影子文件",
	"shadow.description": "这篇笔记是 Lark/飞书知识库文档的本地代理。",
	"shadow.wikiUrl": "Wiki URL",
	"shadow.nodeInfo": "节点信息（通过 lark-cli）",
	"shadow.footer": "这个文件只保存 Front matter 元数据。完整内容仍在 Lark 中，可通过上面的 Wiki URL 查看。",
